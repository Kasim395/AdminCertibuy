...
export const Dashboard = () => {
  ...
  function Card({ adminName, date, time, notice , onclick}) {
	return (
	  <div className="card" style={{backgroundColor:'#E1D9D1'}}>
		<div className="row">
		  <div className="col-md-6">
			<strong>Admin: </strong> {adminName}
		  </div>
		  <div className="col-md-6">
			<strong>Date/Time: <br></br></strong> {date} / {time} 
		  </div>
		</div>
		<div className="row">
		  <div className="col">
		  <strong><br></br>Notice:</strong> 
			<p>{notice}  <br></br> </p> 
		  </div>
		  </div>
	  </div>
    ...
    <div className="dashboard d-flex">
      ...
      <div style={{flex:"1 1 auto", display:"flex", flexFlow:"column", height:"100vh", overflowY:"hidden"}}>
        ...
        <div style={{height:"100%" , backgroundColor:'grey'}}>
	        <div style={{height:"calc(100% - 64px)", overflowY:"scroll"}}>
	          <div className="d-flex card-section">
			   ...
			   <br></br>
			    ...
			    <input type="text" placeholder="Enter Name"  cols={40} onChange={handleChange}
                value={name} />
               </form>
			   <br></br>
			   ...
			   <br></br>
               <textarea className='col-sm' placeholder="... Enter Notice"
		  ...
		  <CDBBtn style={{background:"#333", width:'100%' }} flat size="medium" className="border-0 ml-auto px-2 my-2"
           onClick={dataclick}
          > Update Notice</CDBBtn>
           </div>
		   <div className="col">
           <CDBBtn style={{background:"red", width:'100%' }} flat size="medium" className="border-0 ml-auto px-2 my-2"
           onClick={ async () => db.collection('NoticeBoard').doc(item.id)
		   .delete()}
          > Delete Notice</CDBBtn>
           </div>
        </div>
		</div>
